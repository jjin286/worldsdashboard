...
export const PlayInPlayerTable = () => {
    ...
    useEffect(
        () => {
            const fetchPlayers = async () => {
                const response = await fetch(`http://localhost:8080/${year}/playInPlayer`);
                        ...
                        <table className='table-scroll'>
                            <thead>
                                <tr>
                                    ...
                                    <th onClick={() => onClickSort("goldPerMinute", !sortBy.ascending)}>GPM</th>
