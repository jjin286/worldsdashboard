                                ...
                                {currentRows.map((player) => (
                                    <tr>
                                        <td>
                                            ...
                                            <a className="text-decoration-none" style={{color:'#9E9EB1'}} href={"http://localhost:3000/" + year + "/mainPlayer/" + player.player}>{player.player}</a>
                                        </td>
                                        <td>{player.team}</td>
