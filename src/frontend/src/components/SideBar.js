            ...
            <div>
              ...
              <ul className="nav nav-pills flex-column">
                <li className="nav-item">
                  <a href={`/${year}/team/mainTeam`} className="nav-link text-white fs-5" aria-current="page">
                    <i className="bi bi-people-fill"></i>
                    <span className="ms-2">Main Stage Teams</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a href={`/${year}/team/playInTeam`} className="nav-link text-white fs-5" aria-current="page">
                    <i className="bi bi-people"></i>
                    <span className="ms-2">Play-In Stage Teams</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a href={`/${year}/mainPlayer`} className="nav-link text-white fs-5" aria-current="page">
                    <i className="bi bi-person-fill"></i>
                    <span className="ms-2">Main Stage Players</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a href={`/${year}/playInPlayer`} className="nav-link text-white fs-5" aria-current="page">
                    <i className="bi bi-person"></i>
                    <span className="ms-2">Play-In Stage Players</span>
                  </a>
                </li>
                <li className="nav-item">
                  <a href={`/${year}/champion`} className="nav-link text-white fs-5" aria-current="page">
