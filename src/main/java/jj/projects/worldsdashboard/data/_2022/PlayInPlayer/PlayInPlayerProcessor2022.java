...
public class PlayInPlayerProcessor2022 implements ItemProcessor<PlayInPlayerInput2022, PlayInPlayer2022> {

    // private static final Logger log = LoggerFactory.getLogger(PlayInPlayerProcessor2022.class);

    @Override
    public PlayInPlayer2022 process(final PlayInPlayerInput2022 playerInput) throws Exception {
        PlayInPlayer2022 player = new PlayInPlayer2022();
