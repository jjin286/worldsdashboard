...
public class MainPlayerProcessor2022 implements ItemProcessor<MainPlayerInput2022, MainPlayer2022> {

    // private static final Logger log = LoggerFactory.getLogger(MainPlayerProcessor2022.class);

    @Override
    public MainPlayer2022 process(final MainPlayerInput2022 playerInput) throws Exception {
        MainPlayer2022 player = new MainPlayer2022();
