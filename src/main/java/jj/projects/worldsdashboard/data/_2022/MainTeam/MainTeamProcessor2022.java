...
public class MainTeamProcessor2022 implements ItemProcessor<MainTeamInput2022, MainTeam2022> {

    // private static final Logger log = LoggerFactory.getLogger(MainTeamProcessor2021.class);

    @Override
    public MainTeam2022 process(final MainTeamInput2022 teamInput) throws Exception {
        MainTeam2022 team = new MainTeam2022();
