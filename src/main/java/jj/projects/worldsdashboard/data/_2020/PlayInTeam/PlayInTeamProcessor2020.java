...
public class PlayInTeamProcessor2020 implements ItemProcessor<PlayInTeamInput2020, PlayInTeam2020> {

    // private static final Logger log = LoggerFactory.getLogger(PlayInTeamProcessor2020.class);

    @Override
    public PlayInTeam2020 process(final PlayInTeamInput2020 teamInput) throws Exception {
        PlayInTeam2020 team = new PlayInTeam2020();
