package jj.projects.worldsdashboard.data._2021.Champion;
...
public class ChampionProcessor2021 implements ItemProcessor<ChampionInput2021, Champion2021> {

    // private static final Logger log = LoggerFactory.getLogger(ChampionProcessor2021.class);

    @Override
    public Champion2021 process(final ChampionInput2021 championInput) throws Exception {
        Champion2021 champion = new Champion2021();
